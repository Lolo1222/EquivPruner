...
MERGE_MODEL_NAME=/data1/home/jiawei/llmmcts/merge/origin_final_model_qwen2.5_direct_label
...
POLICY_CUDA_DEVICES="4 5"  # 在GPU 2上运行
...
REWARD_CUDA_DEVICES="6 7"  # 在GPU 3上运行
...
# 为merge model定义GPU设备
MERGE_CUDA_DEVICES="6 7"  # 在GPU 1上运行
